...
guidata(hObject, handles); %%simpan hObject dalam handles
...
% Show image
imshow(originalImage,'parent',handles.axes1); %%SINI-1
...
imshow(~moddedImage,'parent',handles.axes3); %%SINI-2
